// ignore_for_file: avoid_types_as_parameter_names, avoid_print, avoid_function_literals_in_foreach_calls, curly_braces_in_flow_control_structures, non_constant_identifier_names, file_names
  ...
  void _updateBPM() async {
    ...
    while (_toggled) {
      ...
      await Future.delayed(Duration(
          milliseconds:
              5000 * _windowLen ~/ _fs)); // wait for a new set of _data values
    }
  }
}
